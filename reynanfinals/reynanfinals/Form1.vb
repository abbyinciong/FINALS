Public Class Form1
    ...
    Private Sub start()
        ...
        startpoint.Offset(250, 150)
        Cursor.Position = PointToScreen(startpoint)
    End Sub

    Private Sub start(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label2.MouseEnter, Label9.MouseEnter, Label8.MouseEnter, Label7.MouseEnter, Label6.MouseEnter, Label5.MouseEnter, Label4.MouseEnter, Label3.MouseEnter, Label23.MouseEnter, Label22.MouseEnter, Label21.MouseEnter, Label20.MouseEnter, Label19.MouseEnter, Label18.MouseEnter, Label17.MouseEnter, Label16.MouseEnter, Label15.MouseEnter, Label14.MouseEnter, Label13.MouseEnter, Label12.MouseEnter, Label11.MouseEnter, Label10.MouseEnter, Label1.MouseEnter
        start()
        form2.show()
